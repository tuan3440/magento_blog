...
define([
    ...
    return Component.extend({
        ...
        _showSellerNotification: function (sellerData) {
            $('[data-ui-id="menu-hust-service-hust-booking"]').css('position','relative');
            $('[data-ui-id="menu-hust-service-hust-booking"]').css('position', '50px');
            var data = {},
                notifyTmp;
            ...
            $(notifyTmp)
                .appendTo($('[data-ui-id="menu-hust-service-hust-booking"]'));
        },
